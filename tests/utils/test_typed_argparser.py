...
from gato.utils.typed_argparser import TypedArgumentParser, make_choice_type_function, string_to_bool
...
class TypedArgumentParserTest(unittest.TestCase):
    ...
    def test_basic(self):
        parser = TypedArgumentParser(BasicExample)
    ...
    def test_with_default(self):
        parser = TypedArgumentParser(WithDefaultExample)
    ...
    def test_with_default_bool(self):
        ...
        for dataclass_type in dataclass_types:
            parser = TypedArgumentParser(dataclass_type)
            self.argparsersEqual(parser, expected)
    ...
    def test_with_enum(self):
        parser = TypedArgumentParser(MixedTypeEnumExample)
    ...
    def test_with_literal(self):
        ...
        parser = TypedArgumentParser(LiteralExample)
    ...
    def test_with_list(self):
        parser = TypedArgumentParser(ListExample)
    ...
    def test_with_required(self):
        parser = TypedArgumentParser(RequiredExample)
    ...
    def test_with_string_literal_annotation(self):
        parser = TypedArgumentParser(StringLiteralAnnotationExample)
    ...
    def test_parse_json(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            parsed_args = parser.parse_yaml_file(temp_local_path + ".json")[0]
    ...
    def test_parse_yaml(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            parsed_args = parser.parse_yaml_file(temp_local_path + ".yaml")[0]
